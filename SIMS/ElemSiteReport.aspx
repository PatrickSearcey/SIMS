<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SIMSSafety.Master" CodeBehind="ElemSiteReport.aspx.vb" Inherits="SIMS.ElemSiteReport" %>
<%@ MasterType  virtualPath="~/SIMSSafety.master" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register TagPrefix="uc" TagName="ApproveMANU" Src="~/Controls/ApproveMANU.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="server">
    ...
    <asp:Panel ID="pnlMANU" runat="server">
        ...
        <telerik:RadPanelBar ID="rpbInstructions" runat="server" Width="100%" Skin="Web20">
            <Items>
        ...
        <div class="heading">
            <h3 style="margin:0px">Navigation</h3>
        </div>
        <div style="width:100%">
            <div class="linkBox">
        ...
        <br style="clear:left;"/>
        <div class="heading">
            <h3 style="margin:0px;">Select a Site</h3>
        </div>
        <div class="siteSelection">
            ...
            <div style="float:left;">
                <asp:DropDownList ID="rcbSites" runat="server" Width="400px" />
            </div>
            <telerik:RadButton ID="btnSubmitSite" runat="server" Text="Choose this site!" OnCommand="btnSubmitSite_Command" CommandArgument="choosesite" Skin="Web20" />
            <p><b>-OR-</b></p>
            <table>
                <tr>
                    <td>Enter a site number and agency code:</td>
                    <td><asp:TextBox ID="tbSiteNo" runat="server" Width="100px" /></td>
                    <td><asp:TextBox ID="tbAgencyCd" runat="server" Text="USGS" Width="50px" /></td>
                    <td><telerik:RadButton ID="btnSubmitTBSite" runat="server" Text="Go!" OnCommand="btnSubmitSite_Command" CommandArgument="entersite" Skin="Web20" /></td>
                </tr>
                <tr>
        ...
        <div class="heading">
            <h3 style="margin:0px;">Site Details</h3>
        </div>
        <div>
            <telerik:RadGrid ID="rgSiteDetails" runat="server" AutoGenerateColumns="false" EnableLinqExpressions="false"
                Skin="Web20" GridLines="None" ShowStatusBar="true" OnNeedDataSource="rgSiteDetails_NeedDataSource"
        ...
        <asp:Panel ID="pnlucMANU" runat="server" CssClass="MANU">
            <uc:ApproveMANU ID="ucApproveMANU" runat="server" OnSubmitEvent="ucApproveMANU_SubmitEvent" />
        </asp:Panel>
    </asp:Panel>
</asp:Content>
