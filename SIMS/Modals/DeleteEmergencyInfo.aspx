<%@ Page Language="vb" MasterPageFile="~/Modal.master" AutoEventWireup="false" CodeBehind="DeleteEmergencyInfo.aspx.vb" Inherits="SIMS.DeleteEmergencyInfo" %>
...
<div style="padding:5px;">
    <asp:Panel ID="pnlHospital" runat="server" Visible="false">
        <p>By deleting this hospital, you are removing it as the nearest hospital from all sites' JHAs that have it assigned.</p>
    ...
    <asp:Panel ID="pnlContact" runat="server" Visible="false">
        <p>By deleting this contact, you are removing it as the emergency contact from all sites' JHAs that have it assigned.</p>
