<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ElementJHAs.ascx.vb" Inherits="SIMS.ElementJHAs" %>
...
<asp:Panel ID="pnlElement" runat="server" CssClass="roundedPanel">
    ...
    <telerik:RadGrid ID="rgElementHazards" runat="server"  
        ...
        Width="100%" Skin="Web20" CssClass="Custom" AllowSorting="false">
                ...
                <telerik:GridTemplateColumn UniqueName="TemplateLinks" HeaderStyle-Width="185">
                    <ItemTemplate>
                        ...
                        <telerik:RadToolTip runat="server" ID="rtt0" RelativeTo="Element" Width="150px" AutoCloseDelay="10000" 
                            Height="30px" TargetControlID="hlFullReport" IsClientID="false" Animation="Fade" Position="TopRight" Skin="Web20">
                            ...
                            <div style="padding:5px;background-color: #cfe3db;">
                                ...
                                <table cellspacing="0" cellpadding="5" width="100%" border="0" rules="none">
                                    ...
                                    <tr>
                                        ...
                                        <td><telerik:RadComboBox ID="rcbJobLimitType" runat="server" DataTextField="reflevel_tp_desc" DataValueField="reflevel_id" Skin="Web20" Width="400px" />
                                        </td>
                                    </tr>
                                    <tr>
