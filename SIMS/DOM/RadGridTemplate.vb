...
Public Class RadGridTemplate
    ...
    Sub label_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim site_no As String = (DirectCast(container.DataItem, DataRowView))("site_no").ToString()
    ...
    Sub hyperlinkImage_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim container As GridDataItem = DirectCast(hl.NamingContainer, GridDataItem)
        Dim site_id As Integer = (DirectCast(container.DataItem, DataRowView))("site_id")
    ...
    Sub hyperlink_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim container As GridDataItem = DirectCast(h.NamingContainer, GridDataItem)
        Dim rms_record_id As Integer = (DirectCast(container.DataItem, DataRowView))("rms_record_id")
    ...
    Sub image_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim container As GridDataItem = DirectCast(i.NamingContainer, GridDataItem)
        Dim lock_type As String
        Dim lock_uid As String
        Dim lock_dt As String
        Dim rms_record_id As Integer

        If (DirectCast(container.DataItem, DataRowView))("lock_type").ToString Is DBNull.Value Then
            lock_type = ""
        Else
            lock_type = (DirectCast(container.DataItem, DataRowView))("lock_type").ToString
        End If

        If (DirectCast(container.DataItem, DataRowView))("lock_uid").ToString Is DBNull.Value Then
            lock_uid = ""
        Else
            lock_uid = (DirectCast(container.DataItem, DataRowView))("lock_uid").ToString
        End If

        If (DirectCast(container.DataItem, DataRowView))("lock_dt").ToString Is DBNull.Value Then
            lock_dt = ""
        Else
            lock_dt = (DirectCast(container.DataItem, DataRowView))("lock_dt").ToString
        End If

        rms_record_id = (DirectCast(container.DataItem, DataRowView))("rms_record_id")
