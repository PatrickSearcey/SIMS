<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SIMSSafety.Master" CodeBehind="SHAReport.aspx.vb" Inherits="SIMS.SHAReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="server">
    ...
    <asp:Panel ID="pnlNWReport" runat="server">
            ...
            <telerik:RadPageView runat="server" ID="rpv0">
                <div style="padding:10px;">
                    ...
                    <telerik:RadGrid ID="rgNWStatus" runat="server" AutoGenerateColumns="false" EnableLinqExpressions="false" 
                        Skin="Web20" GridLines="None" ShowStatusBar="true" PageSize="50" OnNeedDataSource="rgNWStatus_NeedDataSource"
                        AllowSorting="true" 
            ...
            <telerik:RadPageView runat="server" ID="rpv1">
                <div style="padding:10px;">
                    ...
                    <telerik:RadGrid ID="rgNWReview" runat="server" AutoGenerateColumns="false" EnableLinqExpressions="false" 
                        Skin="Web20" GridLines="None" ShowStatusBar="true" PageSize="50" OnNeedDataSource="rgNWReview_NeedDataSource"
                        AllowSorting="true" 
                        AllowMultiRowSelection="false" 
                        AllowFiltering="true"
                        AllowPaging="true"
            ...
            <telerik:RadPageView runat="server" ID="rpv2">
                <div style="padding:10px;">
                    ...
                    <telerik:RadGrid ID="rgNWApprove" runat="server" AutoGenerateColumns="false" EnableLinqExpressions="false" 
                        Skin="Web20" GridLines="None" ShowStatusBar="true" PageSize="50" OnNeedDataSource="rgNWApprove_NeedDataSource"
                        AllowSorting="true" 
                        AllowMultiRowSelection="false" 
                        AllowFiltering="true"
                        AllowPaging="true"
            ...
            <telerik:RadPageView runat="server" ID="rpv3">
                <div style="padding:10px;">
                    ...
                    <telerik:RadGrid ID="rgNWSitesNoSHA" runat="server" AutoGenerateColumns="false" EnableLinqExpressions="false" 
                        Skin="Web20" GridLines="None" ShowStatusBar="true" PageSize="50" OnNeedDataSource="rgNWSitesNoSHA_NeedDataSource"
                        AllowSorting="true" 
                        AllowMultiRowSelection="false" 
                        AllowFiltering="true"
                        AllowPaging="true"
    ...
    <asp:Panel ID="pnlWSCReport" runat="server">
        <p>Use the filters in the column headings to narrow down the results shown, and click on the headings to sort by that column. Click the tabs to view SHAs by status. 
             If you are not a safety approver for your WSC, you will only see the option to "view" and "review" in the Take Action column of the SHAs Requiring Approval tab. The
            <b>Status</b> column refers to the site. A status of <b>I</b> is for inactive sites, and a status of <b>A</b> is for active sites.
        </p>
        <telerik:RadTabStrip runat="server" ID="rts2" Orientation="HorizontalTop" SelectedIndex="0" MultiPageID="rmp2" Skin="Web20">
            <Tabs>
                <telerik:RadTab Text="Currently Approved SHAs" SelectedCssClass="selectedTab" SelectedIndex="0" />
                <telerik:RadTab Text="SHAs Requiring Review" SelectedCssClass="selectedTab" />
                <telerik:RadTab Text="SHAs Requiring Approval" SelectedCssClass="selectedTab" />
            ...
            <telerik:RadPageView runat="server" ID="rpv5">
                <div style="padding:10px;">
                    ...
                    <telerik:RadGrid ID="rgReview" runat="server" AutoGenerateColumns="false" EnableLinqExpressions="false" 
                        Skin="Web20" GridLines="None" ShowStatusBar="true" PageSize="50" OnNeedDataSource="rgReview_NeedDataSource"
                        AllowSorting="true" 
                        AllowMultiRowSelection="false" 
                        AllowFiltering="true"
                        AllowPaging="true"
            ...
            <telerik:RadPageView runat="server" ID="rpv7">
                <div style="padding:10px;">
                    ...
                    <telerik:RadGrid ID="rgSitesNoSHA" runat="server" AutoGenerateColumns="false" EnableLinqExpressions="false" 
                        Skin="Web20" GridLines="None" ShowStatusBar="true" PageSize="50" OnNeedDataSource="rgSitesNoSHA_NeedDataSource"
                        AllowSorting="true" 
                        AllowMultiRowSelection="false" 
                        AllowFiltering="true"
                        AllowPaging="true"
