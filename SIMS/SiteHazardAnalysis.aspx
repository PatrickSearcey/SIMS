<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SIMSSafety.Master" CodeBehind="SiteHazardAnalysis.aspx.vb" Inherits="SIMS.SiteHazardAnalysis" %>
<%@ Register TagPrefix="uc" TagName="ElementJHAs" Src="~/Controls/ElementJHAs.ascx" %>
...
<asp:Panel ID="pnlHasAccess" runat="server">
    ...
    <!-- SAFETY WARNINGS -->
    <div class="basicPanel" style="float:left;margin-top:0px;">
    ...
    <div class="basicPanel">
                ...
                <asp:ListView runat="server" ID="lvServicingSiteSpecificCond" OnItemDataBound="lvServicingSiteSpecificCond_ItemDataBound">
                    ...
                    <ItemTemplate>
                        ...
                        <telerik:RadToolTip runat="server" ID="rtt0" RelativeTo="Element" Width="150px" AutoCloseDelay="10000"
                            Height="30px" TargetControlID="ibDeleteHazard" IsClientID="false" Animation="Fade" Position="TopRight" Skin="Web20">
                            Delete this remark.
                        </telerik:RadToolTip>
                        <telerik:RadToolTip runat="server" ID="rtt1" RelativeTo="Element" Width="300px" AutoCloseDelay="10000"
                            Height="50px" TargetControlID="ibChangePriority" IsClientID="false" Animation="Fade" Position="TopRight" Skin="Web20">
                        ...
                        <telerik:RadToolTip ID="rtt2" runat="server" relativeto="Element" Width="300px" AutoCloseDelay="10000" 
                            Height="30px" TargetControlID="ibEditHazard" IsClientID="false" Animation="Fade" Position="TopRight" Skin="Web20">
                            Edit this remark.
                        </telerik:RadToolTip>
                    </ItemTemplate>
                    <EmptyDataTemplate>
        ...
        <asp:Panel ID="pnlAddSiteSpecificInfo" runat="server" CssClass="addServicingSiteInfo">
            ...
            <div style="margin: 3px 0px 0px 0px;font-size: 8pt;width:100%;text-align:right;"><asp:LinkButton ID="lbCloseAddSiteSpecificInfo" runat="server" OnCommand="lbAddSiteSpecificInfo_Command" CommandArgument="close">Done adding? 
    ...
    <div class="basicPanel">
        ...
        <asp:Panel ID="pnlEmergencyContacts" runat="server" CssClass="roundedPanel">
            ...
            <telerik:RadGrid ID="rgContacts" runat="server" AllowPaging="true"
                ...
                Width="98%" Skin="Web20" AllowFilteringByColumn="false">
    ...
    <div class="basicPanel">
        ...
        <asp:Panel ID="pnlAdmin" runat="server" CssClass="roundedPanel">
            ...
            <asp:Panel ID="pnlReviewSubmit" runat="server" Visible="false">
                <p style="margin-top:0px;">Enter reviewer comments below, then click the button to submit as reviewed.</p>
