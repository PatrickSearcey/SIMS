...
namespace RMS
{
    public partial class MasterPage : System.Web.UI.MasterPage
    {
        ...
        protected void SetupPageHyperlinks()
        {
            ...
            hlAuditRecordsList.NavigateUrl = String.Format("{0}Report/RecordProcess.aspx?task=audit", Config.RMSURL);
            ...
            hlAuditChart.NavigateUrl = String.Format("{0}Report/AuditChart.aspx", Config.RMSURL);
