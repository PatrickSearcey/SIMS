...
<asp:Content ID="Content3" ContentPlaceHolderID="cph2" runat="server">
    ...
    <div class="mainContent">
        <div style="padding:10px;">
            <p>
                You may choose to retrieve details for a given time period for all records in a field trip, or by individual record.
            </p>
            <table>
                <tr>
                    ...
                    <td><telerik:RadDropDownList ID="rddlRecords" runat="server" DataValueField="rms_record_id" DataTextField="SiteRecord" Skin="Bootstrap" Width="500px" DropDownHeight="500px" /></td>
                </tr>
                <tr>
        ...
        <telerik:RadTabStrip runat="server" ID="rts1" Orientation="HorizontalTop" SelectedIndex="0" MultiPageID="rmp1" Skin="Bootstrap">
            ...
            <telerik:RadPageView runat="server" ID="rpv1">
                <p style="font-weight:bold;padding: 0 5px 0 5px;">
                    <asp:DataList ID="dlChangeLogs" runat="server">
                        <ItemTemplate>
                            ...
                            <asp:DataList ID="dlInnerDialogs" runat="server" OnItemDataBound="dlInnerDialogs_ItemDataBound" Width="100%">
                                <ItemTemplate>
                                    ...
                                    <div style="padding-left:10px;">
                                        ...
                                        <asp:DataGrid ID="dgDialog" runat="server" AutoGenerateColumns="false" Width="95%" BackColor="White" CellPadding="5">
                                            <Columns>
