<%@ Page Title="" Language="C#" MasterPageFile="~/SIMSSingleMenu.Master" AutoEventWireup="true" CodeBehind="MAI.aspx.cs" Inherits="SIMS2017.StationDoc.MAI" %>
        ...
        <telerik:RadTabStrip runat="server" ID="rts1" Orientation="HorizontalTop" SelectedIndex="0" MultiPageID="rmp1" Skin="Bootstrap" OnTabClick="rts1_TabClick">
            ...
            <telerik:RadPageView runat="server" ID="rpv0">
                <div style="padding:10px;">
                    ...
                    <telerik:RadPanelBar ID="rpbInstructions1" runat="server" Width="100%" Skin="Bootstrap">
                        <Items>
                            <telerik:RadPanelItem Text="Steps for approving a manuscript (click here to collapse/expand)" Expanded="true">
                                <ContentTemplate>
                                    <div style="padding: 0 5px 10px 5px;font-size:10pt;line-height:15px;">
            ...
            <telerik:RadPageView runat="server" ID="rpv1">
                <div style="padding:10px;">
                    ...
                    <telerik:RadPanelBar ID="rpbInstructions2" runat="server" Width="100%" Skin="Bootstrap">
                        <Items>
                            <telerik:RadPanelItem Text="Steps for approving a manuscript (click here to collapse/expand)" Expanded="true">
                                <ContentTemplate>
                                    <div style="padding: 0 5px 10px 5px;font-size:10pt;line-height:15px;">
                    ...
                    <telerik:RadGrid ID="rgAllSites" runat="server" AutoGenerateColumns="false" EnableLinqExpressions="false" 
                        Skin="Bootstrap" GridLines="None" ShowStatusBar="true" PageSize="50" OnNeedDataSource="rgAllSites_NeedDataSource"
                        AllowSorting="true" 
                        AllowMultiRowSelection="false" 
                        AllowFiltering="true"
                        AllowPaging="true"
