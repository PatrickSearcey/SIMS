    ...
    public partial class EditDocs : System.Web.UI.Page
    {
        ...
        protected void DropDownList_Logic(RadDropDownList rddl)
        {
            ...
            if (element_id > 0)
            {
                ...
                //LOCATION, DRAINAGE AREA, WELL CHARACTERISTICS (MANU), DATUM, DATE OF LAST LEVELS, and TELEMETRY
                if (element_id == 28 || element_id == 17 || element_id == 106 || element_id == 104 || element_id == 9 || element_id == 1008) 
                {
                    ...
                    //TELEMETRY
                    if (element_id == 1008) pnlTelemetry.Visible = true;
                }
                else
                {
                ...
                switch (rrblAction.SelectedValue)
                {
                    case "Add":
                        ...
                        else pnlEditAddElementInfo.Visible = true;
                    ...
                    case "Delete":
                        ...
                        if (element_id == 1008)
                        {
                            rtbElementInfo.Visible = false;
                            pnlTelemetry.Visible = false;
                        }
                        break;
                }
            }
        ...
        protected void rlvElements_ItemDataBound(object sender, RadListViewItemEventArgs e)
        {
            ...
            if (dataItem != null)
            {
                ...
                //For TELEMETRY - disable link to edit
                if (element_id == 1008)
                {
                    lbElement.Enabled = false;
                }
